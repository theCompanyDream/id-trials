...
func TestGetUlid_Success(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	department := "Engineering"

	expectedUser := &models.UserUlid{
	...
	req := httptest.NewRequest(http.MethodGet, "/ulid/cmk7nncf000054hz3gxgka8v9", nil)
	...
	controller := &controller.UsersUlidControllers{
...
func TestGetUlid_NotFound(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	...
	req := httptest.NewRequest(http.MethodGet, "/ulid/invalid-id", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("id")
...
func TestGetUlid_MissingID(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
...
func TestGetUlids_Success(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	...
	req := httptest.NewRequest(http.MethodGet, "/ulids", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestGetUlids_WithPagination(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	page := 2
	...
	req := httptest.NewRequest(http.MethodGet, "/ulids?page=2&limit=10", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestGetUlids_WithSearch(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	page := 2
	...
	req := httptest.NewRequest(http.MethodGet, "/ulids?search=john", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestCreateUlid_Success(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	...
	mockRepo.On("CreateUser", mock.AnythingOfType("models.UserUlid")).Return(createdUser, nil)

	body, _ := json.Marshal(userInput)
	req := httptest.NewRequest(http.MethodPost, "/ulid", strings.NewReader(string(body)))
...
func TestCreateUlid_ValidationError(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
...
func TestCreateUlid_InvalidJSON(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])

	req := httptest.NewRequest(http.MethodPost, "/ulid", strings.NewReader("invalid json"))
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
...
func TestUpdateUlid_Success(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	...
	mockRepo.On("UpdateUser", mock.AnythingOfType("models.UserUlid")).Return(updatedUser, nil)

	body, _ := json.Marshal(userInput)
	req := httptest.NewRequest(http.MethodPut, "/ulid/"+userID, strings.NewReader(string(body)))
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("id")
...
func TestDeleteUlid_Success(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
	...
	req := httptest.NewRequest(http.MethodDelete, "/ulid/"+userID, nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	c.SetParamNames("id")
	c.SetParamValues(userID)
...
func TestDeleteUlid_MissingID(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])

	req := httptest.NewRequest(http.MethodDelete, "/ulid/", nil)
	rec := httptest.NewRecorder()
	c := e.NewContext(req, rec)
	// No param set
...
func TestDeleteUlid_RepositoryError(t *testing.T) {
	// Arrange
	e := echo.New()
	mockRepo := new(setup.MockRepository[models.UserUlid])
