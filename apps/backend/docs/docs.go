...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/stats.IDTypePerformance"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/stats.RoutePerformance"
                            }
                        }
                    },
                    "500": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/stats.IDEfficiency"
                            }
                        }
                    },
                    "500": {
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/stats.PercentilePoint"
                                }
                            }
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/stats.PercentileTrend"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "stats.TableSize": {
            ...
            "properties": {
                "size": {
                    "description": "Numeric size for charts",
                    "type": "integer"
                },
                "size_bytes": {
                    "description": "Numeric bytes for charts",
                    "type": "integer"
                },
                "size_pretty": {
                    "description": "Human-readable (from PostgreSQL)",
                    "type": "string"
                },
                "table_name": {
                    "type": "string"
